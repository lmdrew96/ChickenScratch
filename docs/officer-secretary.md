# Hen & Ink Society — Secretary (Scroll Gremlin)

> **Purpose of this doc:** Reference guide for the Secretary role, combining constitutional duties with operational realities. For Cody (Claude Code) to use when helping with Secretary-related work.
...
3. **Oversee digital and print archives** of *Chicken Scratch*
4. **Take and keep attendance records** at group meetings
5. **Maintain the "meeting-minutes" channel** on the *word nerds!* Discord server
...
- **Location:** Pinned in the **#meeting-minutes** channel on the *word nerds!* Discord server
...
- **Required to attend all group meetings** — because the Secretaries *are* the minute-takers, attendance is especially critical
...
- [ ] How are duties currently divided between Ashley and Xavier? (e.g., does one handle minutes while the other handles attendance/membership?)
- [ ] Current process for tracking active membership — spreadsheet, Discord roles, or chickenscratch.me feature?
- [ ] Does chickenscratch.me have (or need) Secretary-facing admin features for attendance/membership?

## Resolved (no longer open)

- ✅ Current Secretaries: Ashley and Xavier (co-role)
- ✅ Digital archive location: chickenscratch.me + Nae's computer
- ✅ Meeting minutes: shared Google Doc pinned in #meeting-minutes Discord channel

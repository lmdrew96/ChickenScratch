...
3. **Oversee proofreading and editing of *Chicken Scratch***
...
6. **Oversee/moderate the *word nerds!* Discord server**
...
> **[PENDING FROM MIA]** Mia will provide a transcript of the yearly President training (similar to what Nae has for the Treasurer training). Once received, this section should be updated with the actual training content and paperwork requirements. **For Cody:** if this info isn't here yet, ask Nae for the updated doc.
...
- Oversees the *word nerds!* Discord server
...
- Final editorial decisions on *Chicken Scratch* (Editor-in-Chief's call)
...
- [ ] Specific list of required UD trainings for President role
- [ ] Current status of RSO recognition (what stage is Mia at?)
- [ ] Template/checklist for annual paperwork cycle
- [ ] Any President-specific signing authority with UD departments

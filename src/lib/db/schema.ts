...
export const submissions = pgTable('submissions', {
  ...
  assigned_editor: uuid('assigned_editor'),
  ...
  assigned_coordinator: uuid('assigned_coordinator'),
  assigned_proofreader: uuid('assigned_proofreader'),
  assigned_lead_design: uuid('assigned_lead_design'),
  assigned_editor_in_chief: uuid('assigned_editor_in_chief'),
...
export const officerAvailability = pgTable('officer_availability', {
  id: uuid('id').primaryKey().defaultRandom(),
  user_id: uuid('user_id').notNull(),
  meeting_proposal_id: uuid('meeting_proposal_id').notNull(),

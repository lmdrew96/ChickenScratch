      ...
      {createdUser && (
        <div className="mb-6 bg-green-50 border-2 border-green-500 rounded-lg p-6">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-xl font-bold text-green-800">✓ Test User Created Successfully!</h3>
            <button
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex gap-2">
                <code className="flex-1 bg-white px-3 py-2 rounded border border-green-300 text-sm">
                  {createdUser.email}
                </code>
                <button
            ...
            <div>
              <label className="block text-sm font-semibold text-green-800 mb-1">Temporary Password:</label>
              <div className="flex gap-2">
            ...
            <div>
              <label className="flex items-center gap-2 mb-2">
                <input
                  ...
                  className="w-4 h-4"
                />
                <span className="font-medium">Auto-generate secure password</span>
              </label>
